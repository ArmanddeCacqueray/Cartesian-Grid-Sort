...
**Initialization:**
Take $N$ random Euclidean points (in the main animation example, $N = 4225 = 65 \times 65$ points): 

$$ (x_k, y_k)_{1 \le k \le N} $$

Randomly split the flat key $k$ into a 2D multi-key to form a grid (purely random initialization): 

$$ k \leftrightarrow [i, j]_k \quad \text{and} \quad (x_k, y_k) \leftrightarrow (x_{ij}, y_{ij}) $$
